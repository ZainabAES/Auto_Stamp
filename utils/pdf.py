...
# def stamp_pdf(pdf_paths, stamp_img_path, poppler_path, output_names, size=(409, 214)):
#     """
#     Stamp PDF
#     """
#     stamp_img = Image.open(stamp_img_path)
#     stamp_img = stamp_img.resize(size, Image.ANTIALIAS) #1
...
#         for page in pdf_pages:
#             page = np.array(page)
#             stamped_page = add_stamp(page, np.array(stamp_img), False, False)
#             stamped_page = Image.fromarray(stamped_page.astype('uint8'), 'RGB')
#             stamped_pages.append(stamped_page)
